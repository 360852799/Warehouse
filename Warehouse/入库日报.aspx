<%@ Page Language="C#" AutoEventWireup="true" Inherits="入库日报" MasterPageFile="~/MasterPage.master" Codebehind="入库日报.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <style type="text/css">
        .ininjournal_bottom_div {
            position:absolute;
            top:280px;
            left:200px;
        }
    ...
    <div style="width: 650px; position: absolute; top: 150px; left: 200px; height: 80px; border: 2px solid #cfcaca;">
        <asp:Label ID="Label1" runat="server" Text="按入库时间" CssClass="lab1_style"></asp:Label>
        <br />
        <br />
    ...
    <div id="search" runat="server" class="ininjournal_bottom_div">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" EnableModelValidation="True" OnRowDataBound="GridView1_RowDataBound" Width="853px" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
