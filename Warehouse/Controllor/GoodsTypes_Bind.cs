...
{
    public class GoodsTypes_Bind
    {
        public void Bind1(GridView G1)
        {
            BoundField bf1 = new BoundField(); bf1.HeaderText = "序号"; bf1.DataField = "num";
            BoundField bf2 = new BoundField(); bf2.DataField = "goodsTypeNum"; bf2.HeaderText = "物品类型编号"; bf2.ReadOnly = true; bf2.SortExpression = "goodsTypeNum"; bf2.HeaderStyle.Height = Unit.Parse("40px");
            BoundField bf3 = new BoundField(); bf3.DataField = "goodsTypeName"; bf3.HeaderText = "物品类型名称"; bf3.SortExpression = "goodsTypeName";
            BoundField bf5 = new BoundField(); bf5.DataField = "parentTypeNum"; bf5.HeaderText = "父类别编号"; bf5.SortExpression = "parentTypeNum";
