<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="出库登记.aspx.cs" Inherits="Warehouse.出库登记" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div style="position: absolute; top: 240px; left: 200px; width: 1000px; height: 700px;" runat="server" id="Div1" visible="false">
        <asp:ListBox ID="ListBox5" runat="server" Rows="6" Style="position: absolute; left: 60px; top: 50px; width: 180px; font-size: 19px" Visible="false"></asp:ListBox>
        <asp:Button ID="Button9" runat="server" Text="获取经办人" Style="position: absolute; left: 90px; top: 230px; height: 41px; width: 128px; font-size: 19px" Visible="false" OnClick="Button9_Click" />
        <table style="margin-left: 300px">
            <tr style="line-height: 50px">
                <td>
                    <asp:Label ID="Label9" runat="server" Text="出库编号:" Font-Size="22px"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="TextBox11" runat="server" Style="width: 180px" Font-Size="19px" ReadOnly="true"></asp:TextBox>
            ...
            <tr style="line-height: 50px">
                ...
                <td>
                    <asp:TextBox ID="TextBox12" runat="server" Style="width: 180px" Font-Size="19px" ReadOnly="true" Text="" AutoPostBack="true"></asp:TextBox>
            ...
            <tr style="line-height: 50px">
                <td>
                    <asp:Label ID="Label18" runat="server" Text="出库量:" Font-Size="22px"></asp:Label>
                </td>
                <td>
            ...
            <tr style="line-height: 50px">
                ...
                <td>
                    <asp:TextBox ID="TextBox5" runat="server" Style="width: 180px" Font-Size="19px" Text="" AutoPostBack="true" OnTextChanged="TextBox5_TextChanged"></asp:TextBox>
    ...
    <div style="position: absolute; left: 240px; top: 210px">
        <asp:Button ID="Button1" runat="server" Text="新增出库" Style="border: 2px solid #8e8585; border-radius: 15px; behavior: url(PIE/PIE.htc); background-color: #e8e6e6; width: 120px; height: 40px; font-size: 16px;" OnClick="Button1_Click" />
    ...
    <div style="position: relative; left: 240px; top: 210px">
        <asp:GridView ID="GridView1" runat="server" CssClass="gridview_1" Width="1200px" RowStyle-Height="40px" Visible="true" AutoGenerateColumns="False" PageSize="2" AllowPaging="True" PagerSettings-Mode="NumericFirstLast" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <PagerStyle Font-Names="宋体" Font-Size="20px" HorizontalAlign="Center" />
        </asp:GridView>
        <asp:GridView ID="GridView2" runat="server" CssClass="gridview_1" Width="800px" RowStyle-Height="40px" Visible="false" AutoGenerateColumns="False" PageSize="2" AllowPaging="True" PagerSettings-Mode="NumericFirstLast" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCommand="GridView2_RowCommand" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
            <PagerStyle Font-Names="宋体" Font-Size="20px" HorizontalAlign="Center" />
        </asp:GridView>
    </div>
</asp:Content>
